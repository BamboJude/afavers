                    ...
                    {colJobs.length === 0 ? (
                      ...
                      colJobs.map(job => (
                        <div
                          ...
                          className={`bg-white rounded-xl p-4 border border-gray-200 cursor-grab active:cursor-grabbing hover:shadow-md transition-shadow select-none ${
                            dragging?.id === job.id ? 'opacity-50 scale-95' : ''
                          }`}
                        >
                          <h3
                            className="font-medium text-gray-900 text-sm mb-1 hover:text-blue-600 cursor-pointer line-clamp-2 leading-snug"
